...
`CREATE TABLE IF NOT EXISTS login_tickets(ticket_hash TEXT PRIMARY KEY,application_id TEXT NOT NULL,person_id TEXT NOT NULL,expires_at TEXT NOT NULL,used INTEGER NOT NULL DEFAULT 0,created_at TEXT NOT NULL)`,
...
`CREATE INDEX IF NOT EXISTS idx_audit_time ON audit(created_at)`
 ...
 await DB.prepare("INSERT OR REPLACE INTO settings(key,value) VALUES('schema_version','2.4.0')").run();
